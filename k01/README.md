...
## ソースコードの説明
68.引数を定義する
69.引数を定義し、見つからなかった時のために-１を代入
71~76.keyがidと合うまで繰り返し、見つかったらresultをposにしてfor文から抜けだす。見つからなかったら、resultはそのまま
77.returnの値を返す

83.引数を定義する
84.引数を定義し、見つからなかった時のために-１を代入
85.引数を定義し、0を代入する
86.引数を定義し,0から始まっているので、MAX_CITY　から-１を代入
87.左の値が右の値以下ならwhile文を繰り返す
88.中央の値をposに代入する
89~91.keyがidと一致したらresultにposを代入し、while文から抜け出す
92,93.keyがidより小さいとき、leftをposより一つ大きい数にする
94,95.keyがidより大きいとき、rightをposより一つ小さい数にする
99.resultを返す
